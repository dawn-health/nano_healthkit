...
struct HealthData {
  ...
  enum OneOf_SpecificData: Equatable {
    ...
    static func ==(lhs: HealthData.OneOf_SpecificData, rhs: HealthData.OneOf_SpecificData) -> Bool {
      ...
      switch (lhs, rhs) {
      case (.emptyData, .emptyData): return {
        guard case .emptyData(let l) = lhs, case .emptyData(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      case (.quantityData, .quantityData): return {
        guard case .quantityData(let l) = lhs, case .quantityData(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      case (.categoryData, .categoryData): return {
        guard case .categoryData(let l) = lhs, case .categoryData(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      case (.workoutData, .workoutData): return {
        guard case .workoutData(let l) = lhs, case .workoutData(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      case (.characteristicData, .characteristicData): return {
        guard case .characteristicData(let l) = lhs, case .characteristicData(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      case (.clinicalRecordData, .clinicalRecordData): return {
        guard case .clinicalRecordData(let l) = lhs, case .clinicalRecordData(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      case (.documentData, .documentData): return {
        guard case .documentData(let l) = lhs, case .documentData(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      case (.correlationData, .correlationData): return {
        guard case .correlationData(let l) = lhs, case .correlationData(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
...
struct StatisticsData {
  ...
  struct StatisticsDataBySource {
    ...
    var source: SourceRevision {
      get {return _source ?? SourceRevision()}
    ...
    var data: StatisticsData {
      get {return _data ?? StatisticsData()}
      set {_data = newValue}
    }
    ...
    fileprivate var _source: SourceRevision? = nil
    fileprivate var _data: StatisticsData? = nil
  }
...
extension HealthTypes: @unchecked Sendable {}
extension RequestSorting: @unchecked Sendable {}
extension StatisticsOptions: @unchecked Sendable {}
extension HealthTypeList: @unchecked Sendable {}
extension HealthDataRequest: @unchecked Sendable {}
extension HealthDataRequestList: @unchecked Sendable {}
extension HealthData: @unchecked Sendable {}
extension HealthData.OneOf_SpecificData: @unchecked Sendable {}
extension HealthDataList: @unchecked Sendable {}
extension EmptySpecificData: @unchecked Sendable {}
extension QuantitySpecificData: @unchecked Sendable {}
extension CategorySpecificData: @unchecked Sendable {}
extension WorkoutSpecificData: @unchecked Sendable {}
extension CharacteristicSpecificData: @unchecked Sendable {}
extension ClinicalRecordSpecificData: @unchecked Sendable {}
extension DocumentSpecificData: @unchecked Sendable {}
extension CorrelationSpecificData: @unchecked Sendable {}
extension SourceRevision: @unchecked Sendable {}
extension StatisticsRequest: @unchecked Sendable {}
extension StatisticsData: @unchecked Sendable {}
extension StatisticsData.StatisticsDataBySource: @unchecked Sendable {}
extension StatisticsData.TimeInterval: @unchecked Sendable {}
...
extension HealthDataRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 5: try { try decoder.decodeSingularEnumField(value: &self.sorting) }()
      case 6: try { try decoder.decodeRepeatedStringField(value: &self.units) }()
      default: break
      }
    }
  }
...
extension HealthData: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 2: try { try decoder.decodeSingularStringField(value: &_storage._objectType) }()
        case 3: try { try decoder.decodeSingularStringField(value: &_storage._startDate) }()
        case 4: try { try decoder.decodeSingularStringField(value: &_storage._endDate) }()
        case 5: try { try decoder.decodeSingularStringField(value: &_storage._device) }()
        case 6: try { try decoder.decodeSingularStringField(value: &_storage._metadata) }()
        case 7: try { try decoder.decodeSingularStringField(value: &_storage._uuid) }()
        ...
        case 10: try {
          ...
          if let v = v {
            ...
            _storage._specificData = .emptyData(v)
          }
        }()
        case 11: try {
          ...
          if let v = v {
            if hadOneofValue {try decoder.handleConflictingOneOf()}
            _storage._specificData = .quantityData(v)
          }
        }()
        case 12: try {
          ...
          if let v = v {
            if hadOneofValue {try decoder.handleConflictingOneOf()}
            _storage._specificData = .categoryData(v)
          }
        }()
        case 13: try {
          ...
          if let v = v {
            if hadOneofValue {try decoder.handleConflictingOneOf()}
            _storage._specificData = .workoutData(v)
          }
        }()
        case 14: try {
          ...
          if let v = v {
            if hadOneofValue {try decoder.handleConflictingOneOf()}
            _storage._specificData = .characteristicData(v)
          }
        }()
        case 15: try {
          ...
          if let v = v {
            if hadOneofValue {try decoder.handleConflictingOneOf()}
            _storage._specificData = .clinicalRecordData(v)
          }
        }()
        case 16: try {
          ...
          if let v = v {
            if hadOneofValue {try decoder.handleConflictingOneOf()}
            _storage._specificData = .documentData(v)
          }
        }()
        case 17: try {
          ...
          if let v = v {
            if hadOneofValue {try decoder.handleConflictingOneOf()}
            _storage._specificData = .correlationData(v)
          }
        }()
        default: break
        }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      case .emptyData?: try {
        guard case .emptyData(let v)? = _storage._specificData else { preconditionFailure() }
        try visitor.visitSingularMessageField(value: v, fieldNumber: 10)
      }()
      case .quantityData?: try {
        guard case .quantityData(let v)? = _storage._specificData else { preconditionFailure() }
        try visitor.visitSingularMessageField(value: v, fieldNumber: 11)
      }()
      case .categoryData?: try {
        guard case .categoryData(let v)? = _storage._specificData else { preconditionFailure() }
        try visitor.visitSingularMessageField(value: v, fieldNumber: 12)
      }()
      case .workoutData?: try {
        guard case .workoutData(let v)? = _storage._specificData else { preconditionFailure() }
        try visitor.visitSingularMessageField(value: v, fieldNumber: 13)
      }()
      case .characteristicData?: try {
        guard case .characteristicData(let v)? = _storage._specificData else { preconditionFailure() }
        try visitor.visitSingularMessageField(value: v, fieldNumber: 14)
      }()
      case .clinicalRecordData?: try {
        guard case .clinicalRecordData(let v)? = _storage._specificData else { preconditionFailure() }
...
extension QuantitySpecificData: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 101: try { try decoder.decodeSingularInt64Field(value: &self.count) }()
      case 102: try { try decoder.decodeSingularStringField(value: &self.quantityUnit) }()
      case 103: try { try decoder.decodeSingularDoubleField(value: &self.quantity) }()
      default: break
      }
    }
  }
...
extension CategorySpecificData: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 101: try { try decoder.decodeSingularInt64Field(value: &self.value) }()
      default: break
      }
    }
  }
...
extension WorkoutSpecificData: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 101: try { try decoder.decodeSingularDoubleField(value: &self.totalEnergyBurned) }()
      case 102: try { try decoder.decodeSingularStringField(value: &self.totalEnergyBurnedUnit) }()
      case 103: try { try decoder.decodeSingularDoubleField(value: &self.totalDistance) }()
      case 104: try { try decoder.decodeSingularStringField(value: &self.totalDistanceUnit) }()
      case 105: try { try decoder.decodeSingularDoubleField(value: &self.duration) }()
      default: break
      }
    }
  }
...
extension CharacteristicSpecificData: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 101: try { try decoder.decodeSingularStringField(value: &self.value) }()
      default: break
      }
    }
  }
...
extension ClinicalRecordSpecificData: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 101: try { try decoder.decodeSingularStringField(value: &self.displayName) }()
      case 102: try { try decoder.decodeSingularStringField(value: &self.fhirResource) }()
      default: break
      }
    }
  }
...
extension DocumentSpecificData: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 101: try { try decoder.decodeSingularStringField(value: &self.authorName) }()
      case 102: try { try decoder.decodeSingularStringField(value: &self.custodianName) }()
      case 103: try { try decoder.decodeSingularStringField(value: &self.documentData) }()
      case 104: try { try decoder.decodeSingularStringField(value: &self.patientName) }()
      case 105: try { try decoder.decodeSingularStringField(value: &self.title) }()
      default: break
      }
    }
  }
...
extension CorrelationSpecificData: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 101: try { try decoder.decodeRepeatedMessageField(value: &self.objects) }()
      default: break
      }
    }
  }
...
extension SourceRevision: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 101: try { try decoder.decodeSingularStringField(value: &self.version) }()
      case 102: try { try decoder.decodeSingularStringField(value: &self.operatingSystemVersion) }()
      case 103: try { try decoder.decodeSingularStringField(value: &self.productType) }()
      case 104: try { try decoder.decodeSingularStringField(value: &self.name) }()
      case 105: try { try decoder.decodeSingularStringField(value: &self.bundleIdentifier) }()
      default: break
      }
    }
  }
...
extension StatisticsRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeSingularStringField(value: &self.startDate) }()
      case 3: try { try decoder.decodeSingularStringField(value: &self.endDate) }()
      case 4: try { try decoder.decodeRepeatedEnumField(value: &self.options) }()
      default: break
      }
    }
  }
...
extension StatisticsData: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        // enabled. https://github.com/apple/swift-protobuf/issues/1034
        switch fieldNumber {
        case 1: try { try decoder.decodeRepeatedMessageField(value: &_storage._sources) }()
        case 2: try { try decoder.decodeSingularMessageField(value: &_storage._averageQuantity) }()
        case 3: try { try decoder.decodeSingularMessageField(value: &_storage._maximumQuantity) }()
        case 4: try { try decoder.decodeSingularMessageField(value: &_storage._minimumQuantity) }()
        case 5: try { try decoder.decodeSingularMessageField(value: &_storage._sumQuantity) }()
        case 6: try { try decoder.decodeSingularMessageField(value: &_storage._duration) }()
        case 7: try { try decoder.decodeSingularMessageField(value: &_storage._mostRecentQuantity) }()
        case 8: try { try decoder.decodeSingularMessageField(value: &_storage._mostRecentQuantityDateInterval) }()
        case 9: try { try decoder.decodeSingularMessageField(value: &_storage._dataInterval) }()
        case 10: try { try decoder.decodeRepeatedMessageField(value: &_storage._dataBySource) }()
        default: break
        }
      }
    }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      try { if let v = _storage._averageQuantity {
        try visitor.visitSingularMessageField(value: v, fieldNumber: 2)
      } }()
      try { if let v = _storage._maximumQuantity {
        try visitor.visitSingularMessageField(value: v, fieldNumber: 3)
      } }()
      try { if let v = _storage._minimumQuantity {
        try visitor.visitSingularMessageField(value: v, fieldNumber: 4)
      } }()
      try { if let v = _storage._sumQuantity {
        try visitor.visitSingularMessageField(value: v, fieldNumber: 5)
      } }()
      try { if let v = _storage._duration {
        try visitor.visitSingularMessageField(value: v, fieldNumber: 6)
      } }()
      try { if let v = _storage._mostRecentQuantity {
        try visitor.visitSingularMessageField(value: v, fieldNumber: 7)
      } }()
      try { if let v = _storage._mostRecentQuantityDateInterval {
        try visitor.visitSingularMessageField(value: v, fieldNumber: 8)
      } }()
      try { if let v = _storage._dataInterval {
